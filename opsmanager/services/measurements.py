...
class MeasurementsService(BaseService):
    ...
    # Global lock queues — primary contention indicator (MongoDB 7.0+)
    METRIC_GLOBAL_LOCK_CURRENT_QUEUE_READERS = "GLOBAL_LOCK_CURRENT_QUEUE_READERS"
    METRIC_GLOBAL_LOCK_CURRENT_QUEUE_WRITERS = "GLOBAL_LOCK_CURRENT_QUEUE_WRITERS"
    METRIC_GLOBAL_LOCK_CURRENT_QUEUE_TOTAL = "GLOBAL_LOCK_CURRENT_QUEUE_TOTAL"

    METRIC_RESTARTS_IN_LAST_HOUR = "RESTARTS_IN_LAST_HOUR"

    METRIC_OPLOG_MASTER_TIME = "OPLOG_MASTER_TIME"
    METRIC_OPLOG_REPLICATION_LAG_TIME = "OPLOG_REPLICATION_LAG_TIME"
    METRIC_OPLOG_RATE_GB_PER_HOUR = "OPLOG_RATE_GB_PER_HOUR"
    ...
    METRIC_SYSTEM_NORMALIZED_CPU_IOWAIT = "SYSTEM_NORMALIZED_CPU_IOWAIT"
    METRIC_SYSTEM_NORMALIZED_CPU_STEAL = "SYSTEM_NORMALIZED_CPU_STEAL"
    METRIC_SYSTEM_NORMALIZED_CPU_GUEST = "SYSTEM_NORMALIZED_CPU_GUEST"
    METRIC_SYSTEM_NORMALIZED_CPU_SOFTIRQ = "SYSTEM_NORMALIZED_CPU_SOFTIRQ"
    METRIC_SYSTEM_NORMALIZED_CPU_IRQ = "SYSTEM_NORMALIZED_CPU_IRQ"
    METRIC_SYSTEM_NORMALIZED_CPU_NICE = "SYSTEM_NORMALIZED_CPU_NICE"
    ...
    METRIC_SWAP_USAGE_USED = "SWAP_USAGE_USED"
    METRIC_SWAP_USAGE_FREE = "SWAP_USAGE_FREE"

    # System network
    METRIC_SYSTEM_NETWORK_BYTES_IN = "SYSTEM_NETWORK_BYTES_IN"
    METRIC_SYSTEM_NETWORK_BYTES_OUT = "SYSTEM_NETWORK_BYTES_OUT"
    ...
    METRIC_CACHE_USED_BYTES = "CACHE_USED_BYTES"
    METRIC_CACHE_DIRTY_BYTES = "CACHE_DIRTY_BYTES"
    METRIC_CACHE_FILL_RATIO = "CACHE_FILL_RATIO"
    METRIC_DIRTY_FILL_RATIO = "DIRTY_FILL_RATIO"
    METRIC_CACHE_BYTES_READ_INTO = "CACHE_BYTES_READ_INTO"
    METRIC_CACHE_BYTES_WRITTEN_FROM = "CACHE_BYTES_WRITTEN_FROM"

    # Document metrics
    METRIC_DOCUMENT_METRICS_RETURNED = "DOCUMENT_METRICS_RETURNED"
    METRIC_DOCUMENT_METRICS_INSERTED = "DOCUMENT_METRICS_INSERTED"
    METRIC_DOCUMENT_METRICS_UPDATED = "DOCUMENT_METRICS_UPDATED"
    METRIC_DOCUMENT_METRICS_DELETED = "DOCUMENT_METRICS_DELETED"

    # Query executor
    METRIC_QUERY_EXECUTOR_SCANNED = "QUERY_EXECUTOR_SCANNED"
    METRIC_QUERY_EXECUTOR_SCANNED_OBJECTS = "QUERY_EXECUTOR_SCANNED_OBJECTS"

    # Collection scans
    METRIC_OPERATIONS_SCAN_AND_ORDER = "OPERATIONS_SCAN_AND_ORDER"
    ...
    def get_replication_metrics(
        ...
        return self.host(
            ...
            metrics=[
                ...
                self.METRIC_OPLOG_REPLICATION_LAG_TIME,
                self.METRIC_OPLOG_RATE_GB_PER_HOUR,
